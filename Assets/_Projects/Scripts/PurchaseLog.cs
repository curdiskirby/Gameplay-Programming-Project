...
public class PurchaseLog : MonoBehaviour
{
    ...
    public void StartAutoBerries()
    {
        ...
        if (GlobalBerryFarmer.berryFarmerValue == GlobalBerryBush.berryBushValue)
        {
            GlobalBerryFarmer.berryFarmerValue += 50; // Increases the berryFarmerValue by 50 if it matches the berryBushValue
        }
    ...
    public void BerryBushUpgrade()
    {
        ...
        if (GlobalBerryBush.berryBushValue == GlobalBerryFarmer.berryFarmerValue)
        {
            GlobalBerryBush.berryBushValue += 150; // Increases the berryBushValue by 150 if it matches the berryFarmerValue
        }
