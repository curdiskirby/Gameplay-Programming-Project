...
public class PurchaseLog : MonoBehaviour
{
    ...
    public void StartAutoBerries()
    {
        ...
        GlobalBerryFarmer.berryFarmerValue = (int)(GlobalBerryFarmer.baseBerryFarmerValue * Mathf.Pow(1.15f, StatsDisplayScript.berryFarmerCount)); // Updates the value of berryFarmerValue based on the count of berry farmers
    ...
    public void BerryBushUpgrade()
    {
        ...
        GlobalBerryBush.berryBushValue = (int)(GlobalBerryBush.baseBerryBushValue * Mathf.Pow(1.15f, StatsDisplayScript.berryBushCount)); // Updates the value of berryBushValue based on the count of berry bushes
